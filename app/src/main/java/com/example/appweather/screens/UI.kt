...
fun DialogSearch(dialogState: MutableState<Boolean>, onSubmit: (String) -> Unit) {
    ...
    dialogState.value = false // прячем диалоговое окно
    }, confirmButton = {
        TextButton(onClick = {
        ...
        title = {
            Column(modifier = Modifier.fillMaxWidth()) {
                Text(text = "Введите названия города")
                TextField(value = dialogText.value, onValueChange = {//перерисовка в текстовом поле
                    dialogText.value = it
                })
            }
        }
